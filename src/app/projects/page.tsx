            ...
            <AnimatePresence mode="popLayout">
              {filtered.map((project) => (
                ...
                >
                  ...
                  >
                    {/* Image placeholder */}
                    <div className="aspect-[16/10] bg-gradient-to-br from-navy via-navy-light to-primary/20 relative overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-gray-400 mb-8 max-w-md mx-auto">
              Join 500+ businesses that have trusted Creatomat to power their operations.
            </p>
